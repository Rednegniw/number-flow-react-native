...
```SnackPlayer name=TimeFlow%20Clock dependencies=number-flow-react-native@0.1.4,react-native-reanimated
...
| Prop | Type | Default | Description |
|---|---|---|---|
| `style` | `NumberFlowStyle` | **(required)** | Text styling. `fontSize` is required. |
