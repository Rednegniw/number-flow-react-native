...
| Prop | Type | Default | Description |
|---|---|---|---|
| `style` | `TextStyle` | `undefined` | Text styling. `fontSize` defaults to `16` when omitted; `fontFamily` defaults to the platform system font. Accepts any `TextStyle` property. |
