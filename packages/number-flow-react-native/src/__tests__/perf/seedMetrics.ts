 ...
 * tests (onTextLayout never fires in Jest). Uniform widths keep x positions
 * of unchanged digits stable across value updates, isolating re-render
 * behavior from layout shifts.
 */
